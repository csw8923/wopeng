       ...
       $info  = $this->getImageInfo($image);
         if($info !== false) {
            ...
            if ($suofang==1) {
                ...
                $thumbImg01 = imagecreatetruecolor(260,180);
                imagecopyresampled($thumbImg01,$thumbImg,0,0,$px,$py,260,180,$pw,$ph);

				$thumbImg02 = imagecreatetruecolor(48,48);
                imagecopyresampled($thumbImg02,$thumbImg,0,0,$px,$py,48,48,$pw,$ph);
