...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[["bold","italic","removeformat","justifyleft","wordimage","InsertImage","justifycenter","justifyright","Source"]]
...
//        }
    ...
    //字数统计提示，{#count}代表当前字数，{#leave}代表还可以输入多少字符数,留空支持多语言自动切换，否则按此配置显示
        ...
        ,minFrameWidth:750    //编辑器拖动时最小宽度,默认800
       ...
       // , serialize : {
       //       //黑名单，编辑器会过滤掉一下标签
       //       blackList:{object:1, applet:1, input:1, meta:1, base:1, button:1, select:1, textarea:1, '#comment':1, 'map':1, 'area':1, 'a':0},
