...
<?php
	...
	if($compatible != "1")
	{
		...
		curl_setopt($ch, CURLOPT_URL, $_REQUEST["getdetailurl"]);  
	...
	{
	    $result = file_get_contents($_REQUEST["getdetailurl"]);
	}
	// 编码转换
    ...
    <table id="autotest">
      <tr>
        <td class="xml">
           <pre><code>  
            <?php     
			   $getdetailurl = $_REQUEST["getrange"];
			   ...
			   // ==== 寻找内容 ====
			   $patterns = array();
			   $patterns_temp = $_REQUEST["dpatterns"];
			   ...
			   // ==== 替换内容 ====
			   $replacements = array();
			   $replacements_temp = $_REQUEST["dreplacements"];
