...
(function () {
     ...
     */
      window.UEDITOR_HOME_URL = "/debugueditor/";
    var URL;
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["bold","italic","underline","forecolor","justifyleft","justifycenter","justifyright","justifyjustify","preview","insertimage","insertvideo","attachment","horizontal","searchreplace","print","selectall","cleardoc","link","unlink","snapscreen","source","fullscreen","removeformat","music","emotion","date","wordimage","map","gmap","highlightcode","pagebreak","imagenone","imageleft","imageright","imagecenter","inserttable","splittorows","splittocols","mergedown","mergeright","insertcol","insertrow","deletecol","deleterow","template"]]
    ...
    //,lang:'zh-cn'
        ...
        ,initialContent:'<table width="810"><tbody><tr><td width="150" valign="top" style="word-break:break-all;"><b>问题网址</b>(必填):</td><td width="657" valign="top" style="word-break:break-all;">(这里输入网址)</td></tr><tr><td width="150" valign="top" style="word-break:break-all;"><b>问题描述</b>(必填):</td><td width="657" valign="top" style="word-break:break-all;"><br /></td></tr><tr><td valign="top" style="word-break:break-all;" colspan="2">(这里输入内容)</td></tr><tr><td width="150" valign="top" style="word-break:break-all;"><b>答复|备注</b>(必填):</td><td width="657" valign="top" style="word-break:break-all;"><br /></td><tr><td valign="top" style="word-break:break-all;" colspan="2">(这里输入内容)</td></tr></tbody></table>'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
    ...
    //字数统计提示，{#count}代表当前字数，{#leave}代表还可以输入多少字符数,留空支持多语言自动切换，否则按此配置显示
        ...
        ,minFrameWidth:850    //编辑器拖动时最小宽度,默认800
